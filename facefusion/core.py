...
def apply_args(program : ArgumentParser) -> None:
	...
	# general
	args.target_path = './target/target.jpg'
	facefusion.globals.source_paths = ['./source/1.jpg']
...
async def read_root(paths: Paths):
	...
	image_scale = paths.image_scale

	output_image_resolution = detect_image_resolution(paths.target_path)
	output_image_resolutions = create_image_resolutions(output_image_resolution)
	if image_scale in output_image_resolutions:
